...
public class ToolMaker {
    ...
    private void generateReadme() throws Exception {
        final String template = "README.md.ftl";
        final String path = outputPath + "/README.md";
        generateFileByTemplate(template, path, null);
    }
    ...
    private void generateFileByTemplate(
        ...
        dataMap.put("hasDeleteControl",toolConfiguration.getHasDeleteControl());
        dataMap.put("hasUpdateControl",toolConfiguration.getHasUpdateControl());
        dataMap.put("hasViewControl",toolConfiguration.getHasViewControl());
        //改动
        dataMap.put("searchList",toolConfiguration.getSearchList());
        dataMap.put("classifyList",toolConfiguration.getClassifyList());
        //改动2
        dataMap.put("classifyKey",toolConfiguration.getClassifyKey());
        dataMap.put("hasToolControl",toolConfiguration.getHasToolControl());
        dataMap.put("toolControlDes",toolConfiguration.getToolControlDes());
        dataMap.put("toolControlId",toolConfiguration.getToolControlId());
        dataMap.put("isFromDatabase",toolConfiguration.getIsFromDatabase());
        dataMap.put("connectCondition",toolConfiguration.getConnectCondition());
